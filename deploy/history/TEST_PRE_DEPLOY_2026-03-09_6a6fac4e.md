...
> **Gerado automaticamente por** `./deploy/scripts/predeploy.sh` em 2026-03-09 23:29:46
...
| **Commit local**     | `6a6fac4e`                                                    |
| **Descrição commit** | feat(mobile): adiciona botão Ajustar período no painel de uploads mobile                                                  |
| **Branch em PROD**   | `perf/performance-v2-n0-n4`                                            |
| **Commit em PROD**   | `—` (—)                           |
| **Descrição PROD**   | feat(upload): ajustar período (ano/mês) no painel de uploads                                                 |
...
*FinUp · Gerado por `predeploy.sh` · Branch: perf/performance-v2-n0-n4 · Commit: 6a6fac4e · 2026-03-09 23:29:46*
