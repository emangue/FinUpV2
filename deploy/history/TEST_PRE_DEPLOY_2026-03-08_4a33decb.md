...
> **Gerado automaticamente por** `./deploy/scripts/predeploy.sh` em 2026-03-08 21:39:58
...
| **Commit local**     | `4a33decb`                                                    |
| **Descrição commit** | fix(ui_tests): captura JWT real e injeta como cookie para auth headless persistente                                                  |
...
| UI-02 Login com credenciais corretas | ✅ | Redirecionado para /mobile/dashboard + token injetado |
| UI-03 Dashboard carrega | ❌ | Sem conteúdo no dashboard ([screenshot](deploy/history/screenshots/UI-03_20260308_214027.png)) |
| UI-04 Dashboard — botão 'Mês' visível | ✅ |  |
| UI-05 Dashboard — modo YTD clicável | ✅ |  |
| UI-06 Mobile dashboard — Mês/YTD/Ano Completo | ✅ |  |
| UI-07 Transações — tabela visível | ❌ | Tabela não encontrada ([screenshot](deploy/history/screenshots/UI-07_20260308_214045.png)) |
| UI-08 Budget/Orçamento carrega | ❌ | Sem conteúdo em /budget ([screenshot](deploy/history/screenshots/UI-08_20260308_214101.png)) |
| UI-09 Investimentos carrega | ❌ | Sem conteúdo em /investimentos ([screenshot](deploy/history/screenshots/UI-09_20260308_214117.png)) |
| UI-10 Investimentos/Simulador carrega | ✅ |  |
| UI-11 Upload — zona de upload visível | ❌ | Zona de upload não encontrada ([screenshot](deploy/history/screenshots/UI-11_20260308_214134.png)) |
...
*FinUp · Gerado por `predeploy.sh` · Branch: perf/performance-v2-n0-n4 · Commit: 4a33decb · 2026-03-08 21:39:58*
