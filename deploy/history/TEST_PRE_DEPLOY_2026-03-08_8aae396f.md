...
> **Gerado automaticamente por** `./deploy/scripts/predeploy.sh` em 2026-03-08 21:35:08
...
| **Commit local**     | `8aae396f`                                                    |
| **Descrição commit** | feat(predeploy): mostra versão atual da VM e comando de rollback no checklist                                                  |
...
| **Gerado em**        | 2026-03-08 21:35:08                                                 |
| **Auto: pass/fail**  | 21 ✅ / 1 ❌ / 0 ⏭️ de 22 testes |
| **UI (Playwright)**  | ❌ 5 falha(s)                                               |
...
| B4 | `git status` limpo (sem uncommitted) | ❌ | M deploy/validations/ui_tests.py |
...
| UI-02 Login com credenciais corretas | ✅ | Redirecionado para /mobile/dashboard |
| UI-03 Dashboard carrega | ❌ | Sem conteúdo no dashboard ([screenshot](deploy/history/screenshots/UI-03_20260308_213535.png)) |
| UI-04 Dashboard — botão 'Mês' visível | ✅ |  |
| UI-05 Dashboard — modo YTD clicável | ✅ |  |
| UI-06 Mobile dashboard — Mês/YTD/Ano Completo | ✅ |  |
| UI-07 Transações — tabela visível | ❌ | Tabela não encontrada ([screenshot](deploy/history/screenshots/UI-07_20260308_213554.png)) |
| UI-08 Budget/Orçamento carrega | ❌ | Sem conteúdo em /budget ([screenshot](deploy/history/screenshots/UI-08_20260308_213610.png)) |
| UI-09 Investimentos carrega | ❌ | Sem conteúdo em /investimentos ([screenshot](deploy/history/screenshots/UI-09_20260308_213627.png)) |
| UI-10 Investimentos/Simulador carrega | ✅ |  |
| UI-11 Upload — zona de upload visível | ❌ | Zona de upload não encontrada ([screenshot](deploy/history/screenshots/UI-11_20260308_213653.png)) |
...
*FinUp · Gerado por `predeploy.sh` · Branch: perf/performance-v2-n0-n4 · Commit: 8aae396f · 2026-03-08 21:35:08*
