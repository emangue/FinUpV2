...
> **Gerado automaticamente por** `./deploy/scripts/predeploy.sh` em 2026-03-08 22:00:18
...
| **Commit local**     | `d47541ab`                                                    |
| **Descrição commit** | fix(ui_tests): UI-02 testa acesso direto com cookie (sem form login flaky)                                                  |
| **Branch em PROD**   | `perf/performance-v2-n0-n4`                                            |
| **Commit em PROD**   | `—` (—)                           |
| **Descrição PROD**   | chore(cleanup): commitar deleções e novos docs da limpeza da branch                                                 |
...
| **Gerado em**        | 2026-03-08 22:00:18                                                 |
| **Auto: pass/fail**  | 22 ✅ / 0 ❌ / 0 ⏭️ de 22 testes |
| **UI (Playwright)**  | ❌ 7 falha(s)                                               |
...
| UI-02 Acesso autenticado (cookie) | ✅ | URL: /mobile/onboarding/welcome |
| UI-03 Dashboard carrega | ✅ | URL: /mobile/onboarding/welcome |
| UI-04 Dashboard — botão 'Mês' visível | ❌ | Botão Mês não encontrado ([screenshot](deploy/history/screenshots/UI-04_20260308_220037.png)) |
| UI-05 Dashboard — modo YTD clicável | ❌ | Botão YTD não encontrado ou sem resposta ([screenshot](deploy/history/screenshots/UI-05_20260308_220042.png)) |
| UI-06 Mobile dashboard — Mês/YTD/Ano Completo | ❌ | Toggle móvel não encontrado ([screenshot](deploy/history/screenshots/UI-06_20260308_220053.png)) |
| UI-07 Transações — página carregada | ❌ | Sem conteúdo em /transactions ([screenshot](deploy/history/screenshots/UI-07_20260308_220055.png)) |
| UI-08 Budget/Orçamento carrega | ❌ | Sem conteúdo em /budget ([screenshot](deploy/history/screenshots/UI-08_20260308_220056.png)) |
| UI-09 Investimentos carrega | ❌ | Sem conteúdo em /investimentos ([screenshot](deploy/history/screenshots/UI-09_20260308_220057.png)) |
| UI-10 Investimentos/Simulador carrega | ✅ |  |
| UI-11 Upload — página carregada | ❌ | Sem conteúdo em /upload ([screenshot](deploy/history/screenshots/UI-11_20260308_220059.png)) |
| UI-12 Settings carrega | ✅ |  |
| UI-13 Logout redireciona para login | ⏭️ | Botão Sair não encontrado (verificar manualmente) |
...
*FinUp · Gerado por `predeploy.sh` · Branch: perf/performance-v2-n0-n4 · Commit: d47541ab · 2026-03-08 22:00:18*
