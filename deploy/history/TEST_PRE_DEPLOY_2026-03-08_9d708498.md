...
> **Gerado automaticamente por** `./deploy/scripts/predeploy.sh` em 2026-03-08 21:59:34
...
| **Commit local**     | `9d708498`                                                    |
| **Descrição commit** | fix(ui_tests): injetar JWT real no contexto Playwright + seletores mobile-aware                                                  |
...
| UI-02 Acesso autenticado (cookie) | ✅ | URL: /mobile/dashboard |
| UI-03 Dashboard carrega | ✅ | URL: /mobile/dashboard |
| UI-04 Dashboard — botão 'Mês' visível | ✅ |  |
| UI-05 Dashboard — modo YTD clicável | ✅ |  |
| UI-06 Mobile dashboard — Mês/YTD/Ano Completo | ✅ |  |
| UI-07 Transações — página carregada | ✅ | URL: /mobile/transactions |
| UI-08 Budget/Orçamento carrega | ✅ | URL: /mobile/plano |
| UI-09 Investimentos carrega | ✅ | URL: /mobile/investimentos |
| UI-10 Investimentos/Simulador carrega | ✅ |  |
| UI-11 Upload — página carregada | ✅ | URL: /mobile/upload |
...
*FinUp · Gerado por `predeploy.sh` · Branch: perf/performance-v2-n0-n4 · Commit: 9d708498 · 2026-03-08 21:59:34*
