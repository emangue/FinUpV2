...
// Validate ../../../src/app/api/dashboard/chart-data/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/dashboard/chart-data">> = Specific
  const handler = {} as typeof import("../../../src/app/api/dashboard/chart-data/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
...
// Validate ../../../src/app/api/upload/history/route.ts
{
  type __IsExpected<Specific extends RouteHandlerConfig<"/api/upload/history">> = Specific
  const handler = {} as typeof import("../../../src/app/api/upload/history/route.js")
  type __Check = __IsExpected<typeof handler>
  // @ts-ignore
  type __Unused = __Check
}
