...
import { User, Lock, LogOut, Bell, Moon, Globe, CreditCard, Ban, Upload, Palette, DollarSign } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden divide-y">
          ...
          <button
            onClick={() => router.push('/mobile/grupos')}
            className="w-full flex items-center justify-between p-4 hover:bg-gray-50 transition-colors"
          >
            <div className="flex items-center space-x-3">
              ...
              <span className="font-medium text-gray-900">Central de Grupos</span>
            </div>
            <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
