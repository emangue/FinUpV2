...
export default function ConfiguracoesPage() {
  const [activeTab, setActiveTab] = React.useState<'categorias' | 'bancos'>('categorias')
  ...
  return (
    <DashboardLayout>
      <div className="flex flex-1 flex-col gap-4">
        ...
        <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as 'categorias' | 'bancos')} className="w-full">
