...
def upgrade() -> None:
    ...
    # Dropa tabelas backup antigas (com verificação de existência)
    bind = op.get_bind()
    inspector = sa.inspect(bind)
    existing_tables = inspector.get_table_names()
    
    # Lista de tabelas a dropar (se existirem)
    tables_to_drop = [
